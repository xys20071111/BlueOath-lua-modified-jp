local CancelDisableSkill = class("game.Guide.guidebehaviours.CancelDisableSkill", GR.requires.BehaviourBase)

function CancelDisableSkill:doBehaviour()
