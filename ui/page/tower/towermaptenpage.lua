local TowerMapTenPage = class("UI.Tower.TowerMapTenPage", LuaUIPage)

function TowerMapTenPage:DoInit()
  self.tablePart = {}
end

function TowerMapTenPage:DoOnOpen()
...
function TowerMapTenPage:ShowPath()
  local widgets = self:GetWidgets()
...
function TowerMapTenPage:ShowArrow()
  local widgets = self:GetWidgets()
  local pathListSrc = Data.towerData:GetCopyList()
...
function TowerMapTenPage:ShowPoint(copyId, tablePart)
...
function TowerMapTenPage:_refresh()
  self:ShowPath()
  self:ShowArrow()
...
function TowerMapTenPage:RegisterAllEvent()
  local widgets = self:GetWidgets()
...
function TowerMapTenPage:btn_close()
  self.page:CloseSubPage(self.themeConfig.tower_map)
end

function TowerMapTenPage:setPathMap(pathMap, pathMapPart, src, dst)
