local BattlePassRewardPreviewActivityPage = class("UI.BattlePass.BattlePassActivityPage", LuaUIPage)
local ItemInfoPage = require("ui.page.Common.ItemInfoPage")

function BattlePassRewardPreviewActivityPage:DoInit()
end

function BattlePassRewardPreviewActivityPage:DoOnOpen()
  local cfgs = configManager.GetData("config_battlepass_level_activity")
  local freerewardids = {}
...
function BattlePassRewardPreviewActivityPage:RegisterAllEvent()
...
function BattlePassRewardPreviewActivityPage:DoOnHide()
end

function BattlePassRewardPreviewActivityPage:DoOnClose()
end

return BattlePassRewardPreviewActivityPage
